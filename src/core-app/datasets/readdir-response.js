export default {
  ...
  results: [
    ...
    {
      path: '/Users/Adam/Downloads/brand_sales_NRx (1).csv',
      display_name: 'mocked brand_sales_NRx (1).csv',
      is_directory: false,
      created_at: '2019-02-08T05:00:52.451Z',
      size: 4230292,
    },
    {
      path: '/Users/Adam/Downloads/brand_sales_NRx.csv',
      display_name: 'mocked brand_sales_NRx.csv',
      is_directory: false,
